...
description: Create distinctive, production-grade frontend designs with intentional aesthetics. Use when designing UI components, page layouts, visual identity, or any frontend work that needs to avoid generic patterns and express a clear design point of view. Covers design thinking, aesthetic direction, DFII scoring, typography, color systems, motion, and implementation standards.
---
...
* Motion must be: Purposeful, Sparse, High-impact
...
* No dead styles, no unused animations
* Semantic HTML
...
* **tailwind-patterns** → Utility-first styling
* **seo-audit** → Meta tags and semantic markup
